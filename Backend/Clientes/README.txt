...
a persistence unit "ClientesPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Clientes/pom.xml":
...
artifact ("Clientes.war") is already built. You can build
